...
export class NumberMessageField implements MessageField {
  ...
  constructor(
    ...
    switch (this.messageField.type) {
      ...
      case ProtoMessageFieldType.fixed64: this.protoDataType = 'Fixed64'; break;
      ...
      case ProtoMessageFieldType.int64: this.protoDataType = 'Int64'; break;
      case ProtoMessageFieldType.sfixed32: this.protoDataType = 'Sfixed32'; break;
      case ProtoMessageFieldType.sfixed64: this.protoDataType = 'Sfixed64'; break;
      case ProtoMessageFieldType.sint32: this.protoDataType = 'Sint32'; break;
      case ProtoMessageFieldType.sint64: this.protoDataType = 'Sint64'; break;
      case ProtoMessageFieldType.uint32: this.protoDataType = 'Uint32'; break;
      case ProtoMessageFieldType.uint64: this.protoDataType = 'Uint64'; break;
  ...
  printToBinaryWriter(printer: Printer) {
    printer.add(`if (instance.${this.attributeName} !== undefined && instance.${this.attributeName} !== null) {
      writer.write${this.isArray ? 'Repeated' : ''}${this.protoDataType}(${this.messageField.number}, instance.${this.attributeName});
    }`);
  }
